#ifndef lint
static char rcsid[]="$Header: /nfs/medea/u0/rel5/rcs/Tools/cmusnmp/snmplib/asn1.c,v 1.6 1996/11/14 15:29:40 tpt2 Exp $";
#endif
 ...
 */
     ...
     * this 2's complement unsigned integer.
     * There should be no sequence of 9 consecutive 0's at the most
    ...
    u_long  *length;	/* OUT - value of length field */
{
 	...
 	*length = 0;	    /* only part of length may be overwritten next */
	/* STT Issue: bcopy(3/3B) -> memcpy(3/3C) or memmove(NA/3C)
 ...
 */
    ...
    memmove((char *)objbuf, (char *)objid, objidlength * sizeof(oid));
